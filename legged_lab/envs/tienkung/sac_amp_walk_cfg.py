...
"""SAC+AMP Walk Task Configuration.
...
@configclass
class LiteRewardCfg:
    """Reward configuration for walk task."""
...
class TienKungSACWalkFlatEnvCfg:
    """Environment configuration for SAC+AMP Walk task."""
...
class TienKungSACWalkAgentCfg(RslRlOnPolicyRunnerCfg):
    """Agent configuration for SAC+AMP Walk task."""
    ...
    experiment_name = "sac_amp_walk"
    run_name = ""
    logger = "tensorboard"
    neptune_project = "sac_amp_walk"
    wandb_project = "sac_amp_walk"
    resume = False
    load_run = ".*"
