...
@configclass
class TienKungRunWithSensorFlatEnvCfg:
    ...
    scene: BaseSceneCfg = BaseSceneCfg(
        ...
        depth_camera=TiledD455CameraCfg(debug_vis=True),
    )
...
@configclass
class TienKungRunWithSensorAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    experiment_name = "run_with_sensor"
    run_name = ""
    logger = "tensorboard"
    neptune_project = "run_with_sensor"
    wandb_project = "run_with_sensor"
    resume = False
    load_run = ".*"
