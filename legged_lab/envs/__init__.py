...
from legged_lab.envs.tienkung.walk_ddpg_cfg import (
    TienKungWalkDDPGAgentCfg,
    TienKungWalkDDPGEnvCfg,
)
...
task_registry.register("walk_ddpg", TienKungEnv, TienKungWalkDDPGEnvCfg(), TienKungWalkDDPGAgentCfg())
