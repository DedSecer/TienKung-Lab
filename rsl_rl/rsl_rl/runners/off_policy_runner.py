...
"""Pure SAC Off-Policy Runner.

A standard off-policy runner for SAC without AMP.

Key features:
- Experience collection into replay buffer
- Multiple gradient updates per environment step
- n-step returns for efficient learning
- No AMP/discriminator components
"""
...
class OffPolicyRunner:
    """Off-policy runner for pure SAC training and evaluation.
    
    This runner handles the training loop for SAC algorithm,
    collecting experience into a replay buffer and performing
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        # Get min_std if specified
        min_std = None
        if "min_normalized_std" in train_cfg:
        ...
        # Scale updates_per_step by num_steps_per_env
